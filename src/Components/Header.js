  ...
  return (
    <div className="bg-gradient-to-b from-black flex justify-between items-center px-10 py-2 md:px-24">
      ...
      <div className="flex items-center gap-2">
        ...
        <select className="py-1 px-2 bg-gray-600 bg-opacity-60 text-gray-200 rounded-md border border-gray-500 outline-none">
        ...
        {user && (
          <div className="flex items-center gap-2">
            ...
            />
            <button
              className="bg-red-700 hover:bg-red-800 py-1 px-2 md:px-4 rounded-md text-white shadow-md shadow-gray-800"
